...
const ChartRenderer = props => {
  return (
    <QueryRenderer
      query={{
        measures: ['DriveDriveRoundsRejectedId.RoundsRejectedIdIdxCount'],
        timeDimensions: [],
        order: {},
        dimensions: ['DriveDriveRounds.roundsName'],
        filters: [
          {
            member: 'DriveDrive.id',
            operator: 'equals',
            values: [props.DriveId.toString()]
          }
        ]
      }}
      cubejsApi={cubejsApi}
