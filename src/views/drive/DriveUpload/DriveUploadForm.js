                                            ...
                                            <Grid item xs={6}>
                                                <Box margin={1} paddingBottom={2}>
                                                    <MaterialUiAutocomplete
                                                        ...
                                                        loading={loading3}
                                                        onChange={(event, newValue) => { console.log("selected value", newValue); setCompany3(newValue) }}
                                                        // onSelect={handleResult3}
                                                        renderInput={(params) =>
                                                            <MaterialUiTextField {...params}
                                                                variant="outlined"
                                                                label="Search Company"
                                                                onChange={event => handleChange3(event.target.value)}
                                                                fullWidth
                                                                inputProps={{
                                                                    ...params.inputProps,
                                            ...
                                            <Grid item xs={6}>
                                                <Box margin={1} paddingBottom={2}>
                                                    <MaterialUiAutocomplete
                                                        ...
                                                        includeInputInList
                                                        //disableOpenOnFocus
                                                        onChange={(event, newValue) => { setCoordinators2(newValue); console.log(newValue) }}
                                                        ...
                                                        {values.rounds.map((_, index) => (
                                                            ...
                                                            <div key={index}>
                                                                <Grid container item spacing={3}>
                                                                    ...
                                                                    <Grid item>
                                                                        <Fab size="small" color="secondary" className={classes.delete} aria-label="delete" onClick={() => { remove(index) }}>
                                                                            <DeleteIcon />
                                                                        </Fab>
                                                                    </Grid>
                                                                </Grid>
